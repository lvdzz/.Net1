    ...
    public partial class frmMain : Form
    {
        ...
        private void loaddataTable()
        {
            try
            {
                ...
                for (int i = 0; i < table.Rows.Count; i++)
                {
                    ...
                    //Set trang thai ban
                    if (table.Rows[i][1].ToString() == "OFFLINE")
                    {
        ...
        private void loaddataFood(string nameCategory)
        {
            try
            {
                ...
                txtNameFood.Text = table.Rows[0][0].ToString(); //ten cua  food hien tai
                txtPriceFood.Text = table.Rows[0][2].ToString();  //gia cua  food hien tai
                int y = 10;
                for (int i = 0; i < table.Rows.Count; i++)
                {
                    Button btn = new Button()
        ...
        {
            //Gan text button mon an => text groupbox 
        ...
        private void AddFood()
        {
            try
            {
                ...
                else if (txtSTT.Text == "OFFLINE")
                {
                    DialogResult ms = MessageBox.Show("Chuyển trạng thái của bàn thành ONLINE", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            HoaDon += "\n" + "NHÂN VIÊN: " + label14.Text + " \n\n\n";
            HoaDon += strBill;
            HoaDon += "\n" + "MÃ HÓA ĐƠN: " + label13.Text + "\n";
        ...
        private void tsmMoBan_Click(object sender, EventArgs e)
        {
            ...
            {
                DataProvider provider = new DataProvider();
                provider.Datban("OFFLINE", txtNameTable.Text);
                loaddataTable();
            }
            catch { }
        }

        private void thốngKêBillToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ListBill listBilll = new ListBill();
            listBilll.ShowDialog();
            this.Show();
        }
